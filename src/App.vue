<template>
  ...
  <button @click="initContracts">InitContracts</button>
  <ul>
    <li v-for="(address, name, index) in contracts" :key="index">
      {{ name }}:{{ address }}
    </li>
  </ul>
  <button @click="PlaceOrder">PlaceOrder</button>
  <button @click="AddDelivery">AddDelivery</button>
  <button @click="CompleteOrder">CompleteOrder</button>
  <ul>
  ...
  <button @click="getAllOrders">get orders list</button>
  <ul>
  ...
  <button @click="getAllServices">get services list</button>
  <ul>
